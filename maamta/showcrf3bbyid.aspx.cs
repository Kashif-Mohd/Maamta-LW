...
namespace maamta
{
    public partial class showcrf3bbyid : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (Session["StudyIdCRF3b"] == null)
                {
                    Response.Redirect("showcrf3b.aspx");
                }
                lbeStudyID.Text = Convert.ToString(Session["StudyIdCRF3b"]);
                ShowData();
            }
        }
        ...
        {
            Session["StudyIdCRF3b"] = null;
            Session["form_crf_3b_id"] = null;
            Response.Redirect("showcrf3b.aspx");
        }
        ...
        private void ShowData()
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("select * from view_crf3b where form_crf_3b_id='" + Convert.ToString(Session["form_crf_3b_id"]) + "'", con);
                {
