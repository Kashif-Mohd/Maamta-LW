<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="showcrf5b.aspx.cs" Inherits="maamta.showcrf5b" %>
        ...
        <div style="width: 100%; height: 460px; overflow: scroll; margin-top: 20px">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="followup_num" HeaderText="Followups Number" />
                     <asp:TemplateField HeaderText="Study ID">
                        <ItemTemplate>
                            <asp:LinkButton ID="LinkStudy" OnClick="Link_Study" Text='<%#Eval("study_code") %>' runat="server" ToolTip="Form Detail" CommandArgument='<%#Eval("form_crf_5b_id")+","+ Eval("study_code")%>'></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="Day" HeaderText="Day" />
                    <asp:BoundField DataField="date_of_attempt" HeaderText="Date of Attempt" />
                    <asp:BoundField DataField="time_of_attempt" HeaderText="Time of Attempt" />
                    ...
                    <asp:BoundField DataField="lw_crf5b_18" HeaderText="lw_crf5b_18" />
                    <asp:BoundField DataField="refused_reason" HeaderText="refused_reason" />
                    <asp:BoundField DataField="lw_crf5b_19" HeaderText="lw_crf5b_19" />
                    <asp:BoundField DataField="lw_crf5b_20" HeaderText="lw_crf5b_20" />
                    <asp:BoundField DataField="lw_crf5b_21" HeaderText="lw_crf5b_21" />
                    <asp:BoundField DataField="lw_crf5b_22" HeaderText="lw_crf5b_22" />
                    <asp:BoundField DataField="lw_crf5b_23" HeaderText="lw_crf5b_23" />
                    <asp:BoundField DataField="lw_crf5b_24" HeaderText="lw_crf5b_24" />
                    <asp:BoundField DataField="lw_crf5b_49" HeaderText="lw_crf5b_49" />
                    <asp:BoundField DataField="lw_crf5b_50" HeaderText="lw_crf5b_50" />
                    <asp:BoundField DataField="lw_crf5b_51" HeaderText="lw_crf5b_51" />
                    <asp:BoundField DataField="lw_crf5b_52" HeaderText="lw_crf5b_52" />
                    <asp:BoundField DataField="lw_crf5b_53" HeaderText="lw_crf5b_53" />
                    <asp:BoundField DataField="lw_crf5b_54" HeaderText="lw_crf5b_54" />
                    <asp:BoundField DataField="lw_crf5b_55" HeaderText="lw_crf5b_55" />
                    <asp:BoundField DataField="lw_crf5b_56" HeaderText="lw_crf5b_56" />
                    <asp:BoundField DataField="lw_crf5b_57" HeaderText="lw_crf5b_57" />
                    <asp:BoundField DataField="lw_crf5b_58" HeaderText="lw_crf5b_58" />
                    <asp:BoundField DataField="lw_crf5b_59" HeaderText="lw_crf5b_59" />
            ...
            <asp:GridView ID="GridView2" runat="server" EmptyDataText="No Record Found." OnRowDataBound="OnRowDataBound" CssClass="footable" AllowSorting="false" ForeColor="#333333" AutoGenerateColumns="false">
                <Columns>
                    ...
                    <asp:BoundField DataField="form_crf_5b_id" HeaderText="form_crf_5b_id" />
                    <asp:BoundField DataField="followup_num" HeaderText="Followups_Number" />
                    <asp:BoundField DataField="study_code" HeaderText="Study_ID" />
                    <asp:BoundField DataField="Day" HeaderText="Day" />
                    ...
                    <asp:BoundField DataField="q9" HeaderText="Woman_Name" />
                    <asp:BoundField DataField="q10" HeaderText="Husband_Name" />
                    <asp:BoundField DataField="dssid" HeaderText="DSSID" />
                    <asp:BoundField DataField="site" HeaderText="site" />
                    <asp:BoundField DataField="para" HeaderText="para" />
                    <asp:BoundField DataField="block" HeaderText="block" />
