<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="showcrf3cbyid.aspx.cs" Inherits="maamta.showcrf3cbyid" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="padding-left: 2%; margin-top: 15px;">
        ...
        <br />
        <div style="color: #ff6b6b; font-size: 18px; margin-top: 30px; margin-bottom: 5px; font-family: Arial; font-weight: bold">
            <u>Q20: Occipito-Frontal Head Circumference of Baby (cm)</u>:
        </div>
        ...
        <br />
        <div style="color: #ff6b6b; font-size: 18px; margin-top: 30px; margin-bottom: 5px; font-family: Arial; font-weight: bold">
            <u>Q26: MUAC of LW (cm)</u>:
        </div>

        <asp:GridView ID="GridView8" runat="server" EmptyDataText="No Record Found." CssClass="footable WidthFix" ForeColor="#333333" AutoGenerateColumns="false">
            <Columns>
                <asp:TemplateField HeaderText="Serial no.">
                    <ItemTemplate>
                        <%# Container.DataItemIndex + 1 %>
