...
namespace maamta
{
    public partial class showcrf4bbyid : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                lbeStudyID.Text = Convert.ToString(Session["StudyId_CRF4b"]);
                ShowData();
            }
        }
        ...
        {
            Session["form_crf4b_id"] = null;
            Session["StudyId_CRF4b"] = null;
            Response.Redirect("showcrf4b.aspx");
        }
        ...
        private void ShowData()
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("select * from view_crf4b where form_crf_4b_id='" + Convert.ToString(Session["form_crf4b_id"]) + "'", con);
                {
